...
class ScoreSc extends Component {
    constructor(props){
        super(props);
    ...
    onChangeMoyenneF(e) {
      ...
      cal = () => {
        ...
        +Number(this.state.mathematiques)*1+Number(this.state.sciences)*1.5
        ...
        return (
          <div className="wrappersc">
            ...
            Home
                ...
                <center><p style={{fontSize:"40px"}}>Score Baccalauréat Sciences Expérimentales </p>
